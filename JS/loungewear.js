...
//lounge wear products
document.querySelector("#lounge").addEventListener("click",async ()=>{
    document.querySelector("#lounge").style="color:#fc6486;;"
    document.querySelector("#dressesl").style="color:black;"
    document.querySelector("#topsl").style="color:black;"
    document.querySelector("#bottomsl").style="color:black;"
    document.querySelector("#coordinatesl").style="color:black"
...
//coordinates lounge wear
document.querySelector("#coordinatesl").addEventListener("click",async ()=>{
    document.querySelector("#lounge").style="color:black;"
    document.querySelector("#dressesl").style="color:black;"
    document.querySelector("#topsl").style="color:black;"
    document.querySelector("#bottomsl").style="color:black;"
    document.querySelector("#coordinatesl").style="color:#fc6486;"
    document.querySelector("#under999").style="color:black;"
    document.querySelector("#under799").style="color:black"
    document.querySelector("#under699").style="color:black"
    document.querySelector("#shrugs").style="color:black"
...
//topsl lounge wear
document.querySelector("#topsl").addEventListener("click",async ()=>{
    document.querySelector("#lounge").style="color:black;"
    document.querySelector("#dressesl").style="color:black;"
    document.querySelector("#coordinatesl").style="color:black;"
    document.querySelector("#bottomsl").style="color:black;"
    document.querySelector("#topsl").style="color:#fc6486;"
    document.querySelector("#under999").style="color:black;"
    document.querySelector("#under799").style="color:black"
    document.querySelector("#under699").style="color:black"
    document.querySelector("#shrugs").style="color:black"
...
//dressesl lounge wear
document.querySelector("#dressesl").addEventListener("click",async ()=>{
    document.querySelector("#lounge").style="color:black;"
    document.querySelector("#dressesl").style="color:#fc6486;"
    document.querySelector("#topsl").style="color:black;"
    document.querySelector("#coordinatesl").style="color:black;"
    document.querySelector("#bottomsl").style="color:black;"
    document.querySelector("#under999").style="color:black;"
...
//bottomsl lounge wear
document.querySelector("#bottomsl").addEventListener("click",async ()=>{
    document.querySelector("#lounge").style="color:black;"
    document.querySelector("#dressesl").style="color:black;"
    document.querySelector("#topsl").style="color:black;"
    document.querySelector("#coordinatesl").style="color:black;"
    document.querySelector("#bottomsl").style="color:#fc6486;"
    document.querySelector("#under999").style="color:black;"
    document.querySelector("#under799").style="color:black"
    document.querySelector("#under699").style="color:black"
    document.querySelector("#shrugs").style="color:black"
